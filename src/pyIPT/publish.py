...
def session_open(ipt_auth, ipt_url):
    """
...
def resource_create(projname:str, filepath:str, ipt_url:str, ipt_session):
...
def resource_refresh_files(projname:str, filepath:str, ipt_url:str, ipt_session):
    """
...
def resource_refresh_metadata(projname:str, filepath:str, ipt_url:str, ipt_session):
    """
...
def resource_make_public(projname:str, ipt_url:str, ipt_session):
    """
...
def resource_publish(projname:str, ipt_url:str, ipt_session, publishing_notes:str=""):
    """
    Update metadata for a project on the given IPT
    Author: Jon Pye
    :param projname: the project name 
...
def resource_exists(projname:str, ipt_url:str, ipt_session):
...
def resource_change_publishing_org(projname: str, ipt_url: str, ipt_session, new_publishing_org_name: str):
    """
...
def resource_change_publishing_org_old(projname: str, ipt_url: str, ipt_session, new_publishing_org_name: str):
    """
    Change the publishing organization in the given IPT project
    Author: Mathew Biddle, Jon Pye
    :param projname: the project name 
    :param ipt_url: URL of the IPT to publish to
    :param ipt_session: authenticated requests session for the IPT
    :param new_publishing_org: the new publishing organisation to set for this project. See publishingOrganizationKey in the IPT source.
    ...
    pub_params = {'r' : projname,          # resource = dataset name
                  'id': pub_orgs[new_publishing_org_name],
                  'save':'save'
                 }
    
    contents = ipt_session.post(ipt_url + 'manage/metadata-basic.do', data = pub_params)
    return contents
